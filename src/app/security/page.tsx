...
export default function SecurityPage() {
  return (
    <LegalLayout
      title="Security"
      subtitle="At FRAX, security is fundamental to everything we do. Learn how we protect your data and maintain the trust you place in us."
      lastUpdated="January 26, 2026"
      sections={sections}
    >
      <LegalSection id="commitment" title="Our Commitment to Security">
        <p>
          Security is not just a feature at FRAX—it&apos;s a core principle that guides every decision we make.
      ...
      <LegalSection id="responsible-disclosure" title="Responsible Disclosure">
        ...
        <InfoCard title="Bug Bounty Program" variant="highlight">
          <p>
            ...
            <a href="mailto:security@frax.com" className="text-teal-600 hover:underline">
              security@frax.com
            </a>
            .
          </p>
