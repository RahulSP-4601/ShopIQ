...
export default function CookiePolicyPage() {
  ...
  return (
    <LegalLayout
      title="Cookie Policy"
      subtitle="Learn how FRAX uses cookies and similar technologies to improve your experience and analyze site usage."
    ...
    >
      ...
      <LegalSection id="how-we-use" title="How We Use Cookies">
        <p>
          FRAX uses cookies to improve your experience, understand how you use our platform, and to personalize
