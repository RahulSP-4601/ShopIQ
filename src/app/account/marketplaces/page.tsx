  ...
  const handleConnect = async (marketplace: MarketplaceType) => {
    ...
    try {
      ...
      if (data.requiresCredentials) {
        setError("This marketplace requires credentials. Please add credentials in your account settings or contact support.");
        setLoading(null);
        return;
      }
  ...
  const handlePrestaShopConnect = async () => {
    ...
    try {
      ...
      if (parsed.protocol !== "https:") {
        setError("Please enter a valid PrestaShop store URL (HTTPS required for secure API key transmission)");
        return;
      }
      const hn = parsed.hostname;
      if (!hn || (!hn.includes(".") && hn !== "localhost")) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-teal-50/30">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] lg:w-[600px] lg:h-[600px] bg-gradient-to-br from-teal-100/40 to-emerald-100/30 rounded-full blur-3xl" />
        <div className="absolute -bottom-40 -left-40 w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] lg:w-[600px] lg:h-[600px] bg-gradient-to-tr from-blue-100/30 to-indigo-100/20 rounded-full blur-3xl" />
      </div>
