...
export default function TermsOfServicePage() {
  return (
    <LegalLayout
      ...
      subtitle="Please read these terms carefully before using FRAX. By accessing our platform, you agree to be bound by these terms."
      lastUpdated="January 26, 2026"
      sections={sections}
    >
      <LegalSection id="acceptance" title="Acceptance of Terms">
        <p>
          Welcome to FRAX. By accessing or using our platform, website, or any of our services
      ...
      <LegalSection id="description" title="Description of Service">
        <p>
          FRAX is an AI-powered analytics platform designed for multi-channel e-commerce sellers. Our Service provides:
        </p>
        <LegalList
          items={[
      ...
      <LegalSection id="accounts" title="User Accounts">
        ...
        <InfoCard title="Account Security" variant="warning">
          <p>
            You are responsible for safeguarding your account credentials. FRAX will not be liable for any
      ...
      <LegalSection id="responsibilities" title="User Responsibilities">
        <p>
          As a user of FRAX, you are responsible for:
        </p>
        <LegalList
          items={[
        ...
        />
        <p>
          You acknowledge that FRAX provides tools and insights to assist your business decisions, but
        ...
        <div className="space-y-6">
          <InfoCard title="Our Intellectual Property">
            <p>
              ...
              software, algorithms, designs, graphics, and documentation), is owned by FRAX and protected
      ...
      <LegalSection id="payment" title="Payment and Billing">
        ...
        <div className="grid gap-4 mt-6">
          ...
          <InfoCard title="Taxes">
            <p>
              You are responsible for all applicable taxes, except for taxes based on FRAX&apos;s net income.
      ...
      <LegalSection id="disclaimers" title="Disclaimers and Limitations">
        <InfoCard title="Disclaimer of Warranties" variant="warning">
          ...
          <p>
            To the fullest extent permitted by law, FRAX disclaims all warranties, express or implied,
        ...
        <InfoCard title="Limitation of Liability" variant="warning">
          <p>
            To the maximum extent permitted by law, FRAX shall not be liable for any indirect, incidental,
      ...
      <LegalSection id="indemnification" title="Indemnification">
        <p>
          You agree to indemnify, defend, and hold harmless FRAX, its affiliates, officers, directors,
        ...
        <div className="space-y-6">
          <InfoCard title="Informal Resolution">
            <p>
              ...
              <a href="mailto:legal@frax.com" className="text-teal-600 hover:underline">legal@frax.com</a>{" "}
        ...
        <div className="mt-6 rounded-xl bg-gradient-to-br from-slate-50 to-teal-50 border border-slate-200 p-6">
          <div className="grid sm:grid-cols-2 gap-6">
            <div>
              ...
              <a href="mailto:legal@frax.com" className="text-teal-600 hover:underline">
                legal@frax.com
              </a>
            </div>
            <div>
              <h3 className="font-semibold text-slate-900 mb-2">General Support</h3>
              <a href="mailto:support@frax.com" className="text-teal-600 hover:underline">
                support@frax.com
              </a>
            </div>
