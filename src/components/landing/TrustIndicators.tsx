...
const testimonials = [
  {
    quote: "FRAX helped us identify that our electronics sell 3x better on Amazon than Flipkart. We reallocated inventory and saw a 40% revenue increase.",
    author: "Priya Sharma",
  ...
  {
    quote: "Managing 5 marketplaces was a nightmare until FRAX. Now I get all my insights in one place and actually understand my business.",
    author: "Rajesh Kumar",
