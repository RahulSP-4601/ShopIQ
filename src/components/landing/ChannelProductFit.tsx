        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <p className="fade-up mt-6 text-lg text-slate-600 max-w-lg">
              FRAX&apos;s Channel-Product Fit Engine analyzes 7 performance signals to score how well each product fits each marketplace — then gives you specific, actionable recommendations.
            </p>
