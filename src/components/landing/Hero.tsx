...
const chatConversations = [
  {
    ...
    answer: (
      <>
        ...
        Amazon $22,450 (47%), Shopify $14,280 (30%), Flipkart $7,890 (17%), Snapdeal $2,762 (6%).
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        Your Snapdeal inventory for Kids Wear is low — restocking could capture{" "}
  ...
  },
  {
    ...
    answer: (
      <>
        CAC Analysis: Snapdeal <span className="font-semibold text-teal-400">$2.40</span> (lowest),
        Flipkart $4.80, Amazon $6.20, Shopify $8.90 (highest).
        Snapdeal offers the best ROI for new customers.
      </>
    ),
  },
];
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 flex justify-center">
              <div className="flex items-center gap-2 h-7 rounded-lg bg-white border border-slate-200 px-3 w-full sm:w-64">
                ...
                <span className="text-xs text-slate-500">app.frame.com</span>
              </div>
            </div>
          </div>
        </div>
