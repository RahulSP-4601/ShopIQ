# FRAX Database Documentation

## Core Users

### User
Your clients — business owners who sign up and use FRAX to analyze their sales data across multiple marketplaces.
...
When a client connects their store from any marketplace, one record is created per marketplace per user. Stores encrypted OAuth tokens so FRAX can pull their data automatically.
